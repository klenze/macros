#!/usr/bin/python
import ROOT, os, sys, argparse, re, subprocess
...
def unpack(infiles, output, nev, runNo, exp, ntuple):
...
if __name__=="__main__":
    ...
    if "time-stitch" in args.keys():
        ucesb_options.append("--time-stitch=wr,%d"%args["time-stitch"])
